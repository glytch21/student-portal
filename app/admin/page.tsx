    ...
    <div className="max-w-4xl mx-auto p-6">
      {sessionCookie ? (
        <>
          ...
          <div>
            <form onSubmit={handleSubmit} className="max-w-lg mx-auto mt-8 p-4 border rounded-lg shadow-md bg-white">
              <div className="mb-4">
              ...
              <button type="submit" className="w-full py-2 px-4 border border-transparent rounded-md shadow-sm text-white bg-blue-500 hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50">
                Submit
              </button>
