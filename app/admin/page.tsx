    ...
    <body className="bg-zinc-100 ">
      <div className=" mx-auto p-6 ">
        {sessionCookie ? (
          <>
            {userData ? (
              <div className="absolute top-5 right-5 mb-6 text-2xl font-semibold">
            ...
            <div className="flex mx-auto mt-20">
              <div className="bg-cyan-600 w-64 p-4 h-1/3 flex flex-col justify-center rounded-lg">
                <button
                  onClick={toggleTeachersTable}
                  className="w-full px-4 py-2 mb-4 mt-2  text-white rounded cursor-pointer flex items-center justify-center transition duration-300 ease-in-out hover:bg-cyan-700 focus:bg-cyan-700"
                >
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                        ...
                        <div>
                          ...
                          <input
                            ...
                            className="bg-zinc-200 text-zinc-600 font-mono ring-1 ml-3 ring-zinc-400 focus:ring-2 focus:ring-yellow-400 outline-none duration-300 placeholder:text-zinc-600 placeholder:opacity-50 rounded-full px-4 py-1 shadow-md focus:shadow-lg focus:shadow-yellow-400 mr-2"
                          />
                        </div>
                        <div>
                          <label htmlFor="lastName" className="block mb-1 ml-7">
                            Last Name:
                          </label>
                          <input
                            type="text"
                            ...
                            className="bg-zinc-200 text-zinc-600 font-mono ring-1 ml-7 ring-zinc-400 focus:ring-2 focus:ring-yellow-400 outline-none duration-300 placeholder:text-zinc-600 placeholder:opacity-50 rounded-full px-4 py-1 shadow-md focus:shadow-lg focus:shadow-yellow-400 mr-2"
                          />
                        </div>
                      </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                          ...
                          <div>
                            ...
                            <input
                              ...
                              value={middleName}
                              onChange={(e) => setMiddleName(e.target.value)}
                              className="bg-zinc-200 ml-3 text-zinc-600 font-mono ring-1 ring-zinc-400 focus:ring-2 focus:ring-yellow-400 outline-none duration-300 placeholder:text-zinc-600 placeholder:opacity-50 rounded-full px-4 py-1 shadow-md focus:shadow-lg focus:shadow-yellow-400"
                            />
                          </div>
                          <div>
                            <label
                              htmlFor="lastName"
                              className="block mb-1 ml-5"
                            >
                              Last Name:
                            </label>
                            <input
                              ...
                              value={lastName}
                              onChange={(e) => setLastName(e.target.value)}
                              className="bg-zinc-200 ml-5 text-zinc-600 font-mono ring-1 ring-zinc-400 focus:ring-2 focus:ring-yellow-400 outline-none duration-300 placeholder:text-zinc-600 placeholder:opacity-50 rounded-full px-4 py-1 shadow-md focus:shadow-lg focus:shadow-yellow-400"
                            />
                          </div>
                        </div>
                        <div className="flex justify-between items-center mb-8">
